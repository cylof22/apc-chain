...
@Component({
  selector: 'ch-mobile-public-airdrop',
  templateUrl: './public-airdrop.mobile.component.html',
  styleUrls: ['./public-airdrop.mobile.component.css']
})
export class CHMobilePublicAirdropComponent implements OnInit {
    formModel: FormGroup;
    errorValue: string = '';
