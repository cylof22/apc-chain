...
@Component({
  selector: 'ch-computer-public-airdrop',
  templateUrl: './public-airdrop.computer.component.html',
  styleUrls: ['./public-airdrop.computer.component.css']
})
export class CHCompPublicAirdropComponent implements OnInit {
    formModel: FormGroup;
    errorValue: string = '';
